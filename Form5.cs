...
namespace WinFormsApp3
{
    public partial class Form5 : Form
    {
        ...
        {
            string filePath = @"\\Server\ortak arşiv\txt\form5gecmis.txt";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string queryCheck = "SELECT COUNT(*) FROM kalender WHERE parti_no = @partiNo";
            ...
            try
            {
                ...
                if (count > 0)
                {
                    MessageBox.Show("Bu sipariş zaten Kalendere verilmiş.");
                    return;
                }
                ...
                if (reader.Read())
                {
                    ...
                    string queryInsert = "INSERT INTO kalender (urun_adi, parti_no, urun_id, adet, boyut, bolge, aciklama, tarih, kullanici) VALUES (@urunAdi, @partiNo, @urunId, @adet, @boyut, @bolge, @aciklama, @tarih, @kullanici)";
        ...
        private void LoadDataGridView()
        {
            ...
            string querySelectAll = "SELECT urun_id, parti_no, urun_adi, boyut, adet, bolge, aciklama, kullanici, tarih FROM kalender";
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                using (MySqlConnection mysqlConnection = new MySqlConnection(mysqlConnectionString))
                {
                    try
                    {
                        ...
                        // Ürünün adını al
                        string checkQuery = "SELECT urun_adi FROM kalender WHERE urun_id = @urun_id";
                        ...
                        if (!string.IsNullOrEmpty(urunAdi))
                        {
                            ...
                            string deleteQuery = "DELETE FROM kalender WHERE urun_id = @urun_id"; // Burayı dijitalbaski ile değiştirin
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            using (MySqlConnection mysqlConnection = new MySqlConnection(mysqlConnectionString))
            {
                try
                {
                    ...
                    // Güncelleme sorgusu
                    string updateQuery = "UPDATE kalender SET ";
