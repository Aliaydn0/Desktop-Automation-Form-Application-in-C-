...
namespace WinFormsApp3
{
    public partial class Form3 : Form
    {
        ...
        {
            string filePath = @"\\Server\ortak arşiv\txt\form3gecmis.txt";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string queryCheck = "SELECT COUNT(*) FROM dijitalbaski WHERE parti_no = @partiNo";
            ...
            try
            {
                ...
                if (count > 0)
                {
                    MessageBox.Show("Bu sipariş zaten Dijital Baskıya verilmiş.");
                    return;
                }
                ...
                if (reader.Read())
                {
                    ...
                    // Dijital baskı tablosuna ekleme sorgusu
                    string queryInsert = "INSERT INTO dijitalbaski (urun_adi, parti_no, urun_id, adet, boyut, bolge, aciklama, tarih, kullanici) VALUES (@urunAdi, @partiNo, @urunId, @adet, @boyut, @bolge, @aciklama, @tarih, @kullanici)";
        ...
        private void LoadDataGridView()
        {
            ...
            string querySelectAll = "SELECT urun_id, parti_no, urun_adi, boyut, adet, bolge, aciklama, kullanici, tarih FROM dijitalbaski";
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                using (MySqlConnection mysqlConnection = new MySqlConnection(mysqlConnectionString))
                {
                    try
                    {
                        ...
                        // Ürünün adını al
                        string checkQuery = "SELECT urun_adi FROM dijitalbaski WHERE urun_id = @urun_id";
                        ...
                        if (!string.IsNullOrEmpty(urunAdi))
                        {
                            ...
                            string deleteQuery = "DELETE FROM dijitalbaski WHERE urun_id = @urun_id"; // Burayı dijitalbaski ile değiştirin
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string yeniAdet = textBox2.Text.Trim();
            string yeniAciklama = textBox3.Text.Trim();
            string yeniBoyut = textBox4.Text.Trim();
            ...
            using (MySqlConnection mysqlConnection = new MySqlConnection(mysqlConnectionString))
            {
                try
                {
                    ...
                    // Güncelleme sorgusu
                    string updateQuery = "UPDATE dijitalbaski SET ";
